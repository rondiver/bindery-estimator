  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-lg border border-gray-200 p-6 max-w-3xl">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="finishedSize" className="block text-sm font-medium text-gray-700 mb-1">
              Finished Size *
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="paperStock" className="block text-sm font-medium text-gray-700 mb-1">
              Paper Stock
            </label>
            <input
              type="text"
